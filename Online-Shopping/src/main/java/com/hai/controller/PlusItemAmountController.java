...
/**
 * Servlet implementation class PlusItemAmountController
 */
public class PlusItemAmountController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (amount > 0) {
			...
			String xmlCart = "<Cart><NumberOfItems>" + sessionCart.getCartDetails().size()
					+ "</NumberOfItems><MoneyTotal>" + sessionCart.getMoneyTotal() + "</MoneyTotal>" + cartDetail
					+ "</Cart>";
